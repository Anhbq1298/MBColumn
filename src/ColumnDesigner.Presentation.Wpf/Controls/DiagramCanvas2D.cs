...
public class DiagramCanvas2D : FrameworkElement
{
    ...
    private IEnumerable<ControlPointDto> ReferenceLineBoundsPoints()
    {
        foreach (var line in ReferenceLines ?? [])
        {
            yield return new ControlPointDto(ColumnDesigner.Domain.Enums.DiagramType.PM, line.StartX, line.StartY, line.StartY, line.StartY, 0, 0, 1, 0, 0, line.Label, "ReferenceLine", false, false, true, false);
            yield return new ControlPointDto(ColumnDesigner.Domain.Enums.DiagramType.PM, line.EndX, line.EndY, line.EndY, line.EndY, 0, 0, 1, 0, 0, line.Label, "ReferenceLine", false, false, true, false);
        }
    }
